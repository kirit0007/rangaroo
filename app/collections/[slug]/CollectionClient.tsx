...
export default function CollectionClient({ initialCollection, initialProducts }: { initialCollection: Collection | null, initialProducts: Product[] }) {
  ...
  useEffect(() => {
    if (typeof slug === 'string' && !initialCollection) {
